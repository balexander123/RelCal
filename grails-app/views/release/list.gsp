			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="startDate" title="${message(code: 'release.startDate.label', default: 'Start Date')}" />
				...
				<g:each in="${releaseInstanceList}" status="i" var="releaseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${releaseInstance.id}">${fieldValue(bean: releaseInstance, field: "startDate")}</g:link></td>
